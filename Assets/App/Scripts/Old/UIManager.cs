...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] private RectTransform passButton;
    ...
    public IEnumerator ShowPassButton()
    {
        yield return ScaleUp(passButton);
    }

    public IEnumerator HidePassButton()
    {
        yield return ScaleDown(passButton);
    }
